    ...
    <>
      ...
      <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {trips.map((trip) => {
          ...
          return (
            <Card key={trip.id} className="overflow-hidden transition-shadow hover:shadow-lg">
              ...
              <CardContent className="p-4">
                <CardTitle className="text-lg font-bold font-headline">{trip.title}</CardTitle>
                <CardDescription className="mt-1">{trip.dates}</CardDescription>
